...
public class WheelTest {
    private static double interval = 0.05, tilt = -0.006;
    ...
    public static void main(String[] args) {
       ...
       for (; i < 16555; ) {
            //two = i * 0.9944 + 0.00007 * i * i + 1.2266;
            two = i * 50 / 16384;
            //y = 3.0371 * x + 352.93
        ...
        File file = new File("D:/OneDrive/刘赛赛_研究生期间_工作留底/实验/200909_轮对_重复性实验/0.原始数据/JM");        //获取其file对象
        func(file);
    }
    ...
    public static void downloadData(String path) {
        ...
        double [] measureDataCalc = readData(path);
    ...
    public static void calculateValue(double[] data) {
        try {
            ...
            System.out.println("flangeThicknessN \t" + flangeThicknessN
